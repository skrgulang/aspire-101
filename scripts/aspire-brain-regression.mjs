...
try {
  execFileSync(process.execPath, [
    ...
    '--rootDir', 'lib/aspire-brain',
    '--outDir', tempDir,
    '--skipLibCheck',
    'lib/aspire-brain/index.ts',
    'lib/aspire-brain/entities.ts',
    'lib/aspire-brain/intent.ts',
    'lib/aspire-brain/matcher.ts',
    'lib/aspire-brain/planner.ts',
    'lib/aspire-brain/campusKnowledge.ts'
  ], { stdio: 'inherit' });
