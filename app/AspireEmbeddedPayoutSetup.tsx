  ...
  return (
    <div className="embeddedPayoutShell">
      <div className="embeddedPayoutBrand">
        <div className="embeddedBetaNotice"><b>PRIVATE BETA</b><span>Receiving money is being tested. In Preview, use Stripe sandbox/test information only and do not enter real banking or identity data for beta testing.</span></div>
