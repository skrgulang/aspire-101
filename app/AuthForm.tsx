...
export default function AuthForm({ mode }: { mode: Mode }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (signup) {
        // Reuse the campus lookup already completed while the user was typing.
        // If the email changed before the debounce finished, resolve once here instead
        // of risking a stale campus classification.
