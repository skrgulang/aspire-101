  ...
  return <div className={styles.page}>
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}><nav className={styles.toc}><a href="#respect">01 · Respect people</a><a href="#consent">02 · Mutual choice</a><a href="#honest">03 · Be honest</a><a href="#reviews">04 · Review fairly</a><a href="#safe">05 · Keep it safe</a><a href="#public-space">06 · Public spaces stay non-political</a><a href="#academic">07 · Academic integrity</a><a href="#privacy">08 · Protect privacy</a><a href="#report">09 · Report problems</a></nav><article className={styles.doc}>
        ...
        <section id="public-space" className={styles.section}><h2>6. Public spaces stay non-political</h2><p>Aspire’s public campus feed, marketplace listings, and profile imagery are for campus utility, not political campaigning or propaganda. Do not use public-facing content to promote or oppose political candidates, officeholders, parties, ballot campaigns, or political fundraising, and do not use political leaders, candidates, or officeholders as profile or post imagery. Neutral course-related or civic references may be allowed when they are not advocacy or campaign material. This rule applies consistently regardless of country, party, or viewpoint.</p></section>
        <section id="academic" className={styles.section}><h2>7. Academic integrity</h2><p>Study partners, tutoring, explanations, class advice, and collaboration are welcome when allowed by the course. Requests for cheating, impersonation, taking exams for someone else, or completing prohibited coursework are not.</p></section>
        <section id="privacy" className={styles.section}><h2>8. Protect privacy</h2><p>Do not post someone else’s private contact information, exact address, identity documents, private messages, or sensitive personal data without permission. Approximate campus or distance information is not permission to expose a precise location. Share only what is necessary to complete a request.</p></section>
        <section id="report" className={styles.section}><h2>9. Report problems</h2><p>If a request, account, message, meetup, or interaction seems unsafe or abusive, stop the interaction and use available reporting tools or contact <a href="mailto:team@aspires101.com">team@aspires101.com</a>. Aspire may investigate, remove content, limit contact, suspend accounts, or take other platform-level action when appropriate. For emergencies or imminent danger, contact local authorities or campus emergency services.</p></section>
