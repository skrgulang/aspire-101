        ...
        <section className={styles.card}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.steps}>
              ...
              <div className={styles.step}><b>02</b><strong>Direct data is removed</strong><span>Profile details, verification records, location data, preferences, notifications, AI sessions, and other direct account data are removed or anonymized.</span></div>
            ...
            <div className={styles.notice}>
              ...
              <p>You can save a JSON copy of your profile, settings, requests, connections, messages, reviews, payments, and Resolution Center history before deleting the account.</p>
