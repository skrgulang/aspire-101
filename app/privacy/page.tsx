...
const toc = [
  ['intro','Introduction'],['collect','Information we collect'],['location','Location data'],['reputation','Trust & feedback'],['use','How we use information'],['share','How we share information'],['cookies','Cookies & local storage'],['security','Security'],['retention','Retention'],['rights','Your choices & rights'],['children','Age requirements'],['changes','Changes'],['contact','Contact']
];
  ...
  return <div className={styles.page}>
    ...
    <main className={styles.main}>
      <section className={styles.hero}>
        ...
        <div className={styles.heroMeta}><p><strong>Last updated:</strong> September 12, 2026</p><p>Aspire is built around student requests, campus discovery, mutual connections, messaging, payments, trust signals, and campus relationships. This policy explains what information we use to make those features work.</p></div>
      </section>
      ...
      <div className={styles.content}>
        ...
        <article className={styles.doc}>
          ...
          <section id="collect" className={styles.section}><h2>2. Information we collect</h2><ul><li><strong>Account information:</strong> name or nickname, email, school, profile details, avatar, and authentication information.</li><li><strong>Request activity:</strong> requests, responses, saves, categories, budgets, timestamps, match/connection status, and completion information.</li><li><strong>Messages and interactions:</strong> chats opened from accepted connections, reports, support submissions, collaboration proposals, and related metadata.</li><li><strong>Trust and feedback information:</strong> completed-connection counts, experience tags, “would connect again” feedback, verification status, moderation status, and other account trust signals.</li><li><strong>Payment and transaction information:</strong> amounts, transaction status, order or connection identifiers, refunds, disputes, payout status, and identifiers or metadata provided by payment processors. Payment providers such as Stripe handle sensitive payment credentials; Aspire does not need to store your full card number to operate these flows.</li><li><strong>Technical information:</strong> browser/device information, language, IP address, timestamps, diagnostics, and security logs.</li><li><strong>Optional submissions:</strong> information you send when applying to work with Aspire, including organization details, notes, contact information, or resumes where applicable.</li></ul></section>

          <section id="location" className={styles.section}><h2>3. Location data</h2><p>Aspire can use location to show nearby requests and make campus discovery more useful. We request browser/device location only after you choose a location-enabled feature or grant permission.</p><ul><li>You can deny location access and use manual campus or city selection instead.</li><li>When precise coordinates are available, they may be used temporarily to calculate proximity, distance, or the nearest campus.</li><li>We aim to display approximate location context rather than exposing precise coordinates to other users unless a feature clearly requires and explains it.</li><li>Exact meetup or home addresses should be shared only when a user intentionally chooses to provide them in an appropriate private context.</li></ul></section>

          <section id="reputation" className={styles.section}><h2>4. Trust & feedback</h2><p>Aspire may use one set of account-level trust signals because the same person can be a requester in one interaction and a responder in another. New accounts may appear as “New to Aspire” until enough completed activity exists to support meaningful context.</p><ul><li>Trust signals may include completed-connection counts, experience tags, verification status, or a “would connect again” type signal.</li><li>Feedback may be withheld until both users submit it or until a feedback window closes to reduce retaliation.</li><li>Safety reports are handled separately from ordinary experience feedback and may be visible only to authorized moderation or support personnel.</li><li>We may remove, limit, or investigate feedback that appears fraudulent, abusive, retaliatory, or manipulated.</li></ul></section>

          <section id="use" className={styles.section}><h2>5. How we use information</h2><ul><li>Operate accounts, profiles, request posting, search, responses, mutual matching, messaging, trust features, and notifications.</li><li>Show relevant requests based on campus, category, search terms, and optional location.</li><li>Help users evaluate whether they want to connect by showing appropriate profile and trust information.</li><li>Process and administer supported payments, refunds, payouts, transaction records, and Resolution Center workflows.</li><li>Protect users, prevent spam and abuse, moderate content, investigate reports, and reduce fraud.</li><li>Respond to support, partnership, ambassador, and collaboration inquiries.</li><li>Improve product performance and usability using aggregated or de-identified information where practical.</li><li>Comply with law and enforce our policies.</li></ul></section>

          <section id="share" className={styles.section}><h2>6. How we share information</h2><p><strong>We do not sell personal information.</strong> We may share information with service providers that help us run Aspire, such as hosting, database, storage, email, analytics, maps, security, and payment providers. For supported payments, processors such as Stripe receive information needed to process charges, refunds, connected-account onboarding, transfers, payouts, fraud checks, or disputes. We may also disclose information when required by law, needed to protect users, or as part of a business transaction such as a merger or reorganization.</p><p>Information you intentionally post to public or campus-visible areas, including parts of a profile or trust signal, may be seen by other users according to the feature’s visibility settings.</p></section>
          ...
          <section id="retention" className={styles.section}><h2>9. Retention</h2><p>We retain information for as long as needed to operate Aspire, maintain safety and records, resolve disputes, and meet legal obligations. Account information is generally kept while an account is active. Some safety, moderation, transaction, accounting, dispute, fraud-prevention, or trust records may be retained for a reasonable period after an interaction or account closure when needed to protect users, reconcile transactions, prevent abuse, or satisfy legal obligations.</p></section>

          <section id="rights" className={styles.section}><h2>10. Your choices & rights</h2><ul><li>Update or correct account information.</li><li>Control browser location permission through your device or browser settings.</li><li>Use available account controls to manage profile visibility, notifications, and personalization.</li><li>Request access to or deletion of personal information where applicable.</li><li>Withdraw consent for optional processing where consent is the legal basis.</li><li>Exercise additional rights available under applicable privacy laws.</li></ul><p>We may need to verify identity before completing certain requests, and some records may be retained where legally permitted or required for accounting, disputes, fraud prevention, safety, or platform integrity.</p></section>
          ...
          <p className={styles.note}>This policy reflects Aspire’s current location, mutual-connection, messaging, trust, marketplace, payment, account-control, and Resolution Center features. Final production policies should be reviewed by qualified counsel for the jurisdictions where Aspire operates.</p>
        </article>
      </div>
    </main>
  </div>;
