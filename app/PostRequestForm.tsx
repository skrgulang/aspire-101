...
const categories: CategoryOption[] = [
  ...
  { label: 'Buy & sell', value: 'Buy & sell', icon: '
...
, prompt: 'What item are you looking for?', examples: ['Looking for a mini fridge near campus', 'Looking for a desk lamp near campus'], defaultKind: 'buy_sell' },
  { label: 'Something else', value: 'Other', icon: '…', prompt: 'Ask campus anything useful.', examples: ['Where do people actually study late?', 'Anyone want to ski Saturday?'], defaultKind: 'community' }
];
