...
export async function POST(request: Request) {
  try {
    ...
    const checkoutParams: Record<string, string | number | boolean | null | undefined> = {
      ...
      'line_items[1][price_data][product_data][name]': 'Aspire Protect Fee',
      'line_items[1][price_data][product_data][description]': 'Aspire Protected payment, support, trust & safety, and dispute tools.',
