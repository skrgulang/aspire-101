-- Keep Aspire Live coordination monotonic and prevent a scheduled task from
-- being started before the mutually agreed start time. Once a task is in
-- progress, its agreed schedule can no longer be changed underneath it.
