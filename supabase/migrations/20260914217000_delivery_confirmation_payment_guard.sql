-- Final-state guard for delivery confirmation.
-- 20260914214000_delivery_closeout_bridge.sql adds connection closeout bridging after
-- 20260914211000_delivery_payment_guard.sql, so this migration deliberately reasserts
-- the paid-reward security check while preserving the closeout confirmation behavior.
...
begin
  ...
  -- The helper's successful receiver-code confirmation is their proof-backed
  -- connection completion confirmation. Money release remains a separate server path.
